...
// node_modules/@chakra-ui/utils/node_modules/framesync/dist/es/create-render-step.js
...
// node_modules/@chakra-ui/utils/node_modules/framesync/dist/es/index.js
var maxElapsed = 40;
...
var EmotionCacheContext = (0, import_react2.createContext)(typeof HTMLElement !== "undefined" ? emotion_cache_browser_esm_default({
  key: "css"
}) : null);
if (true) {
...
var useInsertionEffect2 = React3["useInsertionEffect"] ? React3["useInsertionEffect"] : function useInsertionEffect3(create) {
  create();
};
...
var useInsertionEffect5 = React4["useInsertionEffect"] ? React4["useInsertionEffect"] : import_react3.useLayoutEffect;
...
function createContext5(options) {
  ...
  function useContext8() {
    ...
    if (!context && strict) {
      ...
      Error.captureStackTrace == null ? void 0 : Error.captureStackTrace(error2, useContext8);
      throw error2;
    }
    return context;
  }
...
var useInsertionEffect7 = React6["useInsertionEffect"] ? React6["useInsertionEffect"] : function useInsertionEffect8(create) {
  create();
};
...
var ThemeProvider3 = function ThemeProvider4(props) {
  ...
  return React7.createElement(ThemeProvider, {
    theme: computedTheme
  }, React7.createElement(CSSVars, {
    root: cssVarsRoot
  }), children);
};
var CSSVars = function CSSVars2(_ref) {
  ...
  return React7.createElement(Global, {
...
var _createContext = createContext5({
  name: "StylesContext",
...
function useToken(scale, token2, fallback) {
  ...
  if (Array.isArray(token2)) {
    ...
    return token2.map(function(token3, index) {
      var _fallbackArr$index2;
      if (scale === "breakpoints") {
        var _fallbackArr$index;
        return resolveBreakpointValue(theme, token3, (_fallbackArr$index = fallbackArr[index]) != null ? _fallbackArr$index : token3);
      }
      var path2 = scale + "." + token3;
      return resolveTokenValue3(theme, path2, (_fallbackArr$index2 = fallbackArr[index]) != null ? _fallbackArr$index2 : token3);
    });
  }
  if (scale === "breakpoints") {
    return resolveBreakpointValue(theme, token2, fallback);
  }
  var path = scale + "." + token2;
...
function useProps(themeKey, props) {
  ...
  var memoizedStyles = (0, import_react10.useMemo)(function() {
    if (styleConfig) {
...
var Icon = forwardRef3(function(props, ref) {
  var element = props.as, viewBox = props.viewBox, _props$color = props.color, color2 = _props$color === void 0 ? "currentColor" : _props$color, _props$focusable = props.focusable, focusable = _props$focusable === void 0 ? false : _props$focusable, children = props.children, className = props.className, __css = props.__css, rest = _objectWithoutPropertiesLoose3(props, _excluded4);
  var _className = cx("chakra-icon", className);
  var styles = _extends6({
    w: "1em",
    h: "1em",
  ...
  if (element && typeof element !== "string") {
    return React8.createElement(chakra.svg, _extends6({
      as: element
    }, shared, rest));
  }
...
function createIcon(options) {
  ...
  var path = React8.Children.toArray(options.path);
  var Comp = forwardRef3(function(props, ref) {
    return React8.createElement(Icon, _extends6({
      ref,
      viewBox
    }, defaultProps, props), path.length ? path : React8.createElement("path", {
      fill: "currentColor",
      d: pathDefinition
    }));
  });
...
export {
  ...
  keyframes,
  mergeRefs,
  createContext5 as createContext,
  getValidChildren,
 ...
 */
//# sourceMappingURL=chunk-CHR7MOZ6.js.map
